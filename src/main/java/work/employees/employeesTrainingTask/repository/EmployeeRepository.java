...
//    List<Employee> findByGender(Character gender, Pageable pageable);
//
//    List<Employee> findByHireDateAfter(Date date, Pageable pageable);
//
//    List<Employee> findByHireDateBefore(Date date, Pageable pageable);
}
